...
var text_key := ""
var img := ""
var requirements_met_text := "" # Requirement to absorb the shock
...
func add_requirements(p_requirements_met_text: String, p_conditions_to_meet_requirements: Array[Callable], p_requirements_met_effects: Array[Callable]):
	self.requirements_met_text = p_requirements_met_text
