...
# Adds a new line to the graph and returns it to work on it directly
func _add_new_line_to_graph(line_name: String, line_color: Color = Color(1,1,1,1), line_width = 2) -> Line2D:
